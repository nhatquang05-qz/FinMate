...
const CategoryFilterModal: React.FC<Props> = ({ visible, categories, initialSelectedIds, onClose, onApply }) => {
...
const styles = StyleSheet.create({
  ...
  modalContent: { backgroundColor: 'white', height: '60%', borderTopLeftRadius: scale(20), borderTopRightRadius: scale(20), padding: scale(20) },
  title: { fontFamily: 'Coiny-Regular', fontSize: scale(22), color: '#04D1C1', textAlign: 'center', marginBottom: scale(20) },
  list: { flex: 1 },
  itemContainer: { flexDirection: 'row', alignItems: 'center', paddingVertical: scale(15) },
  checkbox: { width: scale(24), height: scale(24), borderWidth: 2, borderColor: '#04D1C1', borderRadius: scale(4), justifyContent: 'center', alignItems: 'center' },
  ...
  buttonContainer: { flexDirection: 'row', justifyContent: 'space-between', paddingTop: scale(15) },
