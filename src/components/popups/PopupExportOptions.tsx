...
const PopupExportOptions: React.FC<PopupExportOptionsProps> = ({
    visible,
    onClose,
    onExport,
    isLoading,
    ...
    const renderTab = (type: ExportType, label: string) => (
        <TouchableOpacity
            ...
            <Text style={[styles.tabText, exportType === type && styles.tabTextActive]}>
                {label}
            </Text>
        </TouchableOpacity>
    );
            ...
            <View style={styles.overlay}>
                <View style={styles.container}>
                    ...
                    <View style={styles.inputArea}>
                        ...
                        {exportType === 'month' && (
                            <PopupDatePicker
                                label="Chọn tháng (chọn ngày bất kỳ trong tháng)"
                                date={selectedDate}
                                onDateChange={setSelectedDate}
                            />
                        )}
                        ...
                        {exportType === 'year' && (
                            <PopupDatePicker
                                label="Chọn năm (chọn ngày bất kỳ trong năm)"
                                date={selectedDate}
                                onDateChange={setSelectedDate}
                            />
                        )}
