...
const API_BASE_URL = 'http://192.168.1.178:3000/api'; // dùng ipconfig để lấy địa chỉ IPv4 của máy tính trong phần Wireless LAN adapter Wi-Fi
// 'http://10.1.4.34:3000/api'
