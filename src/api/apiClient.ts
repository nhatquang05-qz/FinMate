...
const API_BASE_URL = 'http://172.16.17.19:3000/api'; // Địa chỉ mới từ ipconfig // dùng ipconfig để lấy địa chỉ IPv4 của máy tính trong phần Wireless LAN adapter Wi-Fi
