...
const SettingScreen = () => {
  ...
  const toggleBiometrics = () => {
    if (!isBiometricsEnabled) {
      Alert.alert("Thông báo", "Tính năng bảo mật vân tay/FaceID sẽ được kích hoạt trong phiên bản tiếp theo.");
    }
    ...
    Alert.alert(
      ...
      [
        ...
        { 
          ...
          onPress: async () => {
            try {
               await AsyncStorage.multiRemove(['user_notifications', 'last_report_check']);
  ...
  const SettingItem = ({ title, icon, isSwitch, value, onToggle, isDestructive, hideArrow, isLoading }: any) => (
    <TouchableOpacity 
